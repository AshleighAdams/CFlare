...
CFLARE_API cflare_response* cflare_response_status(cflare_response* res, uint32_t status);
...
CFLARE_API void cflare_response_header(cflare_response* res, const char* key, const char* value); // add a header to the response
...
CFLARE_API bool cflare_response_data(cflare_response* res, const char* buffer, size_t buffer_len);
